...
//#define TX_ANT_DLY 16456//32850//16300
//#define RX_ANT_DLY 16456///0//16456	
#define TX_ANT_DLY 16460 
...
int main(void)
{
  ...
  LEDS_ON(BSP_LED_0_MASK | BSP_LED_1_MASK | BSP_LED_2_MASK );
    ...
    UNUSED_VARIABLE(xTaskCreate(led_toggle_task_function, "LED0", configMINIMAL_STACK_SIZE + 200, NULL, 0, &led_toggle_task_handle));
    ...
    UNUSED_VARIABLE(xTaskCreate(ss_responder_task_function, "SSTWR_RESP", configMINIMAL_STACK_SIZE + 200, NULL, 5, &ss_responder_task_handle)); 
  #endif // #ifdef USE_FREERTOS
  ...
  /*Initialization UART*/
  boUART_Init ();
  printf("Singled Sided Two Way Ranging RESP Example \r\n");
