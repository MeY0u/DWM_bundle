...
#define TX_ANT_DLY 16456//16300
#define RX_ANT_DLY 16456//16456	
...
int main(void)
{
  ...
  LEDS_ON(BSP_LED_0_MASK | BSP_LED_1_MASK | BSP_LED_2_MASK );
    ...
    UNUSED_VARIABLE(xTaskCreate(ss_initiator_task_function, "SSTWR_INIT", configMINIMAL_STACK_SIZE + 200, NULL, 5, &ss_initiator_task_handle));
  #endif // #ifdef USE_FREERTOS
